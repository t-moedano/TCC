...
var desc = readlineSync.question('Desc: ');

var keyEX = readlineSync.question('Key Exams: ');
var keyMR = readlineSync.question('Key Medical Record: ');
...
FabricClient.newDefaultKeyValueStore({ path: store_path
  ...
  {
    chaincodeId: 'fabcar',
    fcn: 'updateExamResult',
    args: [docType, desc, keyEX, keyMR],
    chainId: 'mychannel',
    txId: transactionId
  };
