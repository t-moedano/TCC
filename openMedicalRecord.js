...
var crm = readlineSync.question('CRM: ');
var docName = readlineSync.question('doc name: ');

var disableToken = readlineSync.question('Disable Token? (D): ');

console.log(rule + ' ' + username);

var ShortUniqueId = require('short-unique-id');
var uid = new ShortUniqueId();
var key = uid.randomUUID(6);

console.log(key);

var tkkey = uid.randomUUID(6);
...
FabricClient.newDefaultKeyValueStore({ path: store_path
  ...
  {
    chaincodeId: 'fabcar',
    fcn: 'openMedicalRecord',
    args: [name, id, rule, key, crm, docName, tkkey, disableToken],
    chainId: 'mychannel',
    txId: transactionId
  };
