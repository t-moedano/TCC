...
var qp = readlineSync.question('QP: ');
var hda = readlineSync.question('HDA: ');
var hmp = readlineSync.question('HMP: ');
var hf = readlineSync.question('HF: ');
var smoke = readlineSync.question('Smoke: ');
var drink = readlineSync.question('Drink: ');
var pression = readlineSync.question('Pression: ');
var heartbeat = readlineSync.question('Heartbeat: ');
var key = readlineSync.question('Key: ');

var ShortUniqueId = require('short-unique-id');
var uid = new ShortUniqueId();
var keyAM = uid.randomUUID(8);
keyAM = 'AM'+keyAM;
...
FabricClient.newDefaultKeyValueStore({ path: store_path
  ...
  var request = 
  {
    chaincodeId: 'fabcar',
    fcn: 'createAnemese',
    args: [id, name, qp, hda, hmp, hf, smoke, drink, pression, heartbeat, docType, key, keyAM],
    chainId: 'mychannel',
    txId: transactionId
  };
