...
var doctorName = readlineSync.question('Doctor Name: ');
var address = readlineSync.question('Address: ');
var hospital = readlineSync.question('Hospital: ');
...
FabricClient.newDefaultKeyValueStore({ path: store_path
  ...
  var request = 
  {
    ...
    args: [docType, id, name, hour, day, doctorName, address, hospital, keyAM, keyTK],
    chainId: 'mychannel',
    txId: transactionId
  };
